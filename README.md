...
| Platform | Download |
|---|---|
| 🪟 **Windows** | [`.exe` installer](https://github.com/sanjaydoc/Web4.0/releases/download/v0.2.4/Web4.0.Setup.0.2.4.exe) · [`.msi`](https://github.com/sanjaydoc/Web4.0/releases/download/v0.2.4/Web4.0.0.2.4.msi) |
| 🍎 **macOS** | [`.dmg` (universal — Apple Silicon + Intel)](https://github.com/sanjaydoc/Web4.0/releases/download/v0.2.4/Web4.0-0.2.4-universal.dmg) |
| 🐧 **Linux** | [`.AppImage`](https://github.com/sanjaydoc/Web4.0/releases/download/v0.2.4/Web4.0-0.2.4.AppImage) · [`.deb`](https://github.com/sanjaydoc/Web4.0/releases/download/v0.2.4/web3_0.2.4_amd64.deb) |
