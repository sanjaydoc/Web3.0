...
| Platform | Download |
|---|---|
| 🪟 **Windows** | [`.exe` installer](https://github.com/sanjaydoc/Web3.0/releases/download/v0.1.27/Web3.0.Setup.0.1.27.exe) · [`.msi`](https://github.com/sanjaydoc/Web3.0/releases/download/v0.1.27/Web3.0.0.1.27.msi) |
| 🍎 **macOS** | [`.dmg` (universal — Apple Silicon + Intel)](https://github.com/sanjaydoc/Web3.0/releases/download/v0.1.27/Web3.0-0.1.27-universal.dmg) |
| 🐧 **Linux** | [`.AppImage`](https://github.com/sanjaydoc/Web3.0/releases/download/v0.1.27/Web3.0-0.1.27.AppImage) · [`.deb`](https://github.com/sanjaydoc/Web3.0/releases/download/v0.1.27/web3_0.1.27_amd64.deb) |
