...
| Platform | Download |
|---|---|
| 🪟 **Windows** | [`.exe` installer](https://github.com/sanjaydoc/Web3.0/releases/download/v0.1.39/Web3.0.Setup.0.1.39.exe) · [`.msi`](https://github.com/sanjaydoc/Web3.0/releases/download/v0.1.39/Web3.0.0.1.39.msi) |
| 🍎 **macOS** | [`.dmg` (universal — Apple Silicon + Intel)](https://github.com/sanjaydoc/Web3.0/releases/download/v0.1.39/Web3.0-0.1.39-universal.dmg) |
| 🐧 **Linux** | [`.AppImage`](https://github.com/sanjaydoc/Web3.0/releases/download/v0.1.39/Web3.0-0.1.39.AppImage) · [`.deb`](https://github.com/sanjaydoc/Web3.0/releases/download/v0.1.39/web3_0.1.39_amd64.deb) |
